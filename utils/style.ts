...
import { ResponsiveProp, Responsive } from "@/types/style";

// themeの型.theme オブジェクトの型を AppTheme としてエクスポート
export type AppTheme = typeof theme;

// SpaceThemeKeys は theme.space オブジェクト内のすべてのキーの型
...
// 各themeのキーの型.スペース、色、フォントサイズなどの個々のテーマ属性に対する型を定義。
// これらの型は、テーマのキー（例：theme.space 内のキー）または任意の文字列として定義。
...
// @params propKey CSSプロパティ
// @pramas value CSSプロパティ
